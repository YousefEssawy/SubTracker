...
const TransactionListItem = ({ transaction }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-surface-dark rounded-2xl border border-gray-200 dark:border-gray-800 px-4 py-3.5 flex items-center gap-4 shadow-sm hover:shadow-md hover:border-primary/30 transition-all cursor-pointer"
    >
      {/* Space icon */}
      <div
